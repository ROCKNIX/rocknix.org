...
{%set hw_connectivity = '2.4/5 GHz Wi-Fi + BT (8821CS)' %}
...
Keep in mind that these settings are not guaranteed to work on future versions of ROCKNIX and might impact the experience (e.g. longer Wi-Fi connection times after resuming from sleep).
